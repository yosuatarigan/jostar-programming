...
class _StorePageState extends State<StorePage> {
  ...
  final List<StoreProduct> _products = [
    StoreProduct(
      ...
      screenshots: [
        'assets/store/pos_1.png',
        'assets/store/pos_2.png',
        'assets/store/pos_3.png',
      ],
      isPopular: true,
      discount: 30,
    ),
    StoreProduct(
      ...
      screenshots: [
        'assets/store/ecommerce_1.png',
        'assets/store/ecommerce_2.png',
        'assets/store/ecommerce_3.png',
      ],
      isPopular: true,
      discount: 28,
    ),
    StoreProduct(
      ...
      screenshots: [
        'assets/store/restaurant_1.png',
        'assets/store/restaurant_2.png',
        'assets/store/restaurant_3.png',
      ],
      isPopular: false,
      discount: 27,
    ),
    StoreProduct(
      ...
      screenshots: [
        'assets/store/healthcare_1.png',
        'assets/store/healthcare_2.png',
        'assets/store/healthcare_3.png',
      ],
      isPopular: false,
      discount: 33,
    ),
    StoreProduct(
      ...
      screenshots: [
        'assets/store/learning_1.png',
        'assets/store/learning_2.png',
        'assets/store/learning_3.png',
      ],
      isPopular: false,
      discount: 25,
    ),
    StoreProduct(
      ...
      screenshots: [
        'assets/store/inventory_1.png',
        'assets/store/inventory_2.png',
        'assets/store/inventory_3.png',
      ],
      isPopular: false,
      discount: 26,
    ),
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            top: 40,
            left: 40,
            child: _buildFloatingIcon(Icons.shopping_cart, AppColors.accent),
          ),
          Positioned(
            top: 60,
            right: 50,
            child: _buildFloatingIcon(Icons.restaurant, AppColors.secondary),
          ),
          Positioned(
            bottom: 80,
            left: 60,
            child: _buildFloatingIcon(Icons.local_hospital, AppColors.primary),
          ),
          Positioned(
            bottom: 40,
            right: 40,
            child: _buildFloatingIcon(Icons.school, AppColors.success),
          ),
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('Klik link di atas untuk melihat demo aplikasi'),
          ],
        ),
        actions: [
          TextButton(
